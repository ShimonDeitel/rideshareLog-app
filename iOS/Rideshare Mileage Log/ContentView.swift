...
struct ContentView: View {
    ...
    @State private var editingItem: DriveEntry?
    ...
    var body: some View {
        NavigationStack {
            ...
            .navigationTitle("Rideshare Mileage Log")
            .toolbar {
    ...
    private func editSheet(for item: DriveEntry) -> some View {
...
struct EditItemView: View {
    ...
    @State var item: DriveEntry
    var onSave: (DriveEntry) -> Void
    var onDelete: () -> Void
